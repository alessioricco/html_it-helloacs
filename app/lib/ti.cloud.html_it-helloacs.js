...
var url = Ti.App.Properties.getString("acs-service-baseurl-html_it-helloacs");

if(!url) throw new Error("Url not found by acs-service-baseurl-html_it-helloacs.");
...
exports.services_hello_htmlit = function(data, cb) {
   var path = [];
   path.push('/hello_htmlit');
   InvokeService(path.join(''), "GET", data, cb);
};
